...
* Shasha Mao, Jingyuan Yang, Shuiping Gou, Licheng Jiao, Tao Xiong, **Lin Xiong**, **"Multi-scale Fused SAR Image Registration based on Deep Forest"**, is accepted by Remote Sensing, vol.13(11): 2227, **2021**. **IF 5.349 (2021)**.[PDF]
(https://github.com/bruinxiong/xionglin.github.io/blob/master/Multi-scale_Fused_SAR_Image_Registration_based_on_Deep_Forest_Remote_Sensing_2021.pdf).
